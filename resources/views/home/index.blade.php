...
/* RESPONSIVE */
@media(max-width:1199px){.hero-grid{grid-template-columns:1fr 380px;gap:50px}.hero-content h1{font-size:46px}.adv-grid{grid-template-columns:repeat(3,1fr)}.services-grid{grid-template-columns:repeat(3,1fr)}}
@media(max-width:991px){.hero-grid{grid-template-columns:1fr}.hero-form-wrap{max-width:500px}.hero-content h1{font-size:38px}.cta-banner-inner{flex-direction:column;text-align:center}.cta-banner-actions{justify-content:center}.services-grid{grid-template-columns:repeat(2,1fr)}.adv-grid{grid-template-columns:repeat(2,1fr)}.steps-grid{grid-template-columns:repeat(2,1fr)}.steps-grid::before{display:none}.reviews-grid{grid-template-columns:repeat(2,1fr)}.stats-bar{grid-template-columns:repeat(2,1fr)}.stat-item:nth-child(2){border-right:none}.stat-item:nth-child(3){border-top:1px solid rgba(255,255,255,0.1)}.contact-grid{grid-template-columns:1fr}}
@media(max-width:767px){.hero{padding:60px 0 70px}.hero-content h1{font-size:30px}.hero-stats{gap:16px}.hero-stat strong{font-size:20px}.services-grid{grid-template-columns:repeat(2,1fr)}.adv-grid{grid-template-columns:1fr 1fr}.steps-grid{grid-template-columns:1fr}.reviews-grid{grid-template-columns:1fr}.stats-bar{grid-template-columns:1fr 1fr}.cta-banner-text h2{font-size:24px}}
@media(max-width:480px){.services-grid{grid-template-columns:1fr}.adv-grid{grid-template-columns:1fr}.stats-bar{grid-template-columns:1fr}.stat-item{border-right:none;border-top:1px solid rgba(255,255,255,0.1)}}
</style>
@endpush
